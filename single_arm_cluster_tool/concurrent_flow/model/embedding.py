...
class LotStageEmbedding(nn.Module):
    ...
    def forward(self, state):
        ...
        ##my stage_order: (batch, self.col_cnt, self.col_cnt)
        ##my stage_capacity: (batch, self.col_cnt, 1)
        ##my stage_purge_time: (batch, self.col_cnt, 1)
        col_emb = self.proj_col_feat(col_feat)
        ## my col_feat: (batch, self.col_cnt, self.col_cnt+2 == self.col_feat_dim)
        ## my col_emb: (batch, self.col_cnt, embedding_dim)
